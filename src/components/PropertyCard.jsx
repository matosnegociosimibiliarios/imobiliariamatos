...
import { propertyLocation, propertyPrice } from '../services/properties';
  ...
  return (
    <article className="property-card">
      <Link className="property-card-image" to={`/imovel/${property.slug}`}>
        ...
        {property.featured && <span className="property-card-badge">Destaque</span>}
      </Link>
      ...
      <div className="property-card-body">
        ...
        <p className="property-card-location">{propertyLocation(property)}</p>
        ...
        <div className="property-card-facts">
          ...
          <Fact value={property.total_area ? `${property.total_area} m²` : null} label="" />
        </div>

        <Link className="button full-button property-card-button" to={`/imovel/${property.slug}`}>
          Ver imóvel
        </Link>
      </div>
    </article>
